...
{
	Fixed a;
	a.setRawBits((_rawBits * other._rawBits) >> _fractionalBits);
	return (a);
}
...
{
	Fixed a;
	a.setRawBits((_rawBits << _fractionalBits) / other._rawBits);
	return (a);
}
...
Fixed&	Fixed::operator++()		{this->_rawBits++; return (*this);}
